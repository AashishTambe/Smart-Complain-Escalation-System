    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar__nav">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar__item">
                    <a href="adminDashboard" class="sidebar__link sidebar__link--active">
    ...
    <main class="app-main">
        <nav class="navbar">
            <div class="navbar__left">
                ...
                <h1 class="navbar__title">Admin Dashboard</h1>
            </div>
            <div class="navbar__right">
                <div class="navbar__profile">
                    <div class="navbar__avatar"><%= userName != null ? userName.substring(0, 1).toUpperCase() : "A" %></div>
                    <span><%= userName != null ? userName : "Admin" %> (ADMIN)</span>
                </div>
        ...
        <div class="app-content">
            ...
            <div class="card">
                <p style="text-align: center; color: var(--color-text-muted);">No complaints found matching your filters.</p>
            </div>
            <% } else { %>
                            ...
                            <td>
                                <form action="updateStatus" method="post" class="complaint-actions">
                                    ...
                                    <select name="status" class="form-select" style="width: auto; padding: 4px 8px; font-size: 12px;">
                                        ...
                                        <option value="ESCALATED" <%= "ESCALATED".equals(c.getStatus()) ? "selected" : "" %>>ESCALATED</option>
